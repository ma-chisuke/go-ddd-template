...
//go:generate go tool ogen --config ../../contracts/api/ordering/openapi.ogen.yaml --target internal/adapter/inbound/openapi --package openapi --clean ../../contracts/api/ordering/openapi.yaml
